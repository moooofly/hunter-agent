			...
			go func(sig os.Signal) {
				...
				case os.Interrupt, syscall.SIGTERM:
					if atomic.LoadUint32(&interruptCount) < 3 {
						...
						logger.Info("Forcing hunter-agent daemon shutdown without cleanup; 3 interrupts received")
					}
				case syscall.SIGQUIT:
					DumpStacks("")
					logger.Info("Forcing hunter-agent daemon shutdown without cleanup on SIGQUIT")
				}
